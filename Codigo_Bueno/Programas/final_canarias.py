...
'''Este es el sector 2'''
df2 = base_datos.loc[base_datos.SectorCode=='GCCCRNE',:]
print(df2.size)
...
with  open(FILES_PATH + "\\JSON_Cargados\\Canarias\\Clusterizados_GCCCRNE.json", "w") as f6:
    json.dump(flujos_clusterizados, f6, indent=4)
f6.close()
with open(FILES_PATH + "\\JSON_Cargados\\Canarias\\Aeropuertos_GCCCRNE.json", "w") as outfile:
    json.dump(aeropuertos, outfile, indent=4)
outfile.close()
with open(FILES_PATH + "\\JSON_Cargados\\Canarias\\Origenes_cluster_GCCCRNE.json", "w") as outfile:
    json.dump(origenes_cluster, outfile, indent=4)
outfile.close()

with open(FILES_PATH + "\\JSON_Cargados\\Canarias\\Destinos_cluster_GCCCRNE.json", "w") as outfile:
...
f7.close()
# Tipo1.5
with  open(FILES_PATH + "\\JSON_Cargados\\Canarias\\Tipo1.5_GCCCRNE.json", "w") as f8:
    json.dump(tipo1_5, f8, indent=4)
f8.close()
# Tipo2
with  open(FILES_PATH + "\\JSON_Cargados\\Canarias\\Tipo2_GCCCRNE.json", "w") as f9:
    json.dump(tipo2, f9, indent=4)
f9.close()
# Asociacion
with  open(FILES_PATH + "\\JSON_Cargados\\Canarias\\Asociacion_GCCCRNE.json", "w") as f10:
    json.dump(asoci_2, f10, indent=4)
f10.close()


with  open(FILES_PATH + "\\JSON_Cargados\\Canarias\\Clusterizados2_GCCCRNE.json", "w") as f6:
    json.dump(flujos_2, f6, indent=4)
f6.close()
#%%
with  open(FILES_PATH + "\\JSON_Cargados\\Canarias\\Clusterizados_GCCCRNE.json", "r") as f6:
...
datos2.to_csv("Canarias_Final.csv", index=False, sep=",")
