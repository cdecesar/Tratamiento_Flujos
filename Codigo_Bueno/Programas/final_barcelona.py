...
'''Este es el sector 2'''
df2 = base_datos.loc[base_datos.SectorCode=='LECBP2R',:]
print(df2.size)
...
with  open(FILES_PATH + "\\JSON_Cargados\\Barcelona\\Clusterizados_LECBP2R.json", "w") as f6:
    json.dump(flujos_clusterizados, f6, indent=4)
f6.close()
with open(FILES_PATH + "\\JSON_Cargados\\Barcelona\\Aeropuertos_LECBP2R.json", "w") as outfile:
    json.dump(aeropuertos, outfile, indent=4)
outfile.close()
with open(FILES_PATH + "\\JSON_Cargados\\Barcelona\\Origenes_cluster_LECBP2R.json", "w") as outfile:
    json.dump(origenes_cluster, outfile, indent=4)
outfile.close()

with open(FILES_PATH + "\\JSON_Cargados\\Barcelona\\Destinos_cluster_LECBP2R.json", "w") as outfile:
...
# Clusterizados
# Tipo1
with  open(FILES_PATH + "\\JSON_Cargados\\Barcelona\\Tipo1_LECBP2R.json", "w") as f7:
    json.dump(tipo1, f7, indent=4)
f7.close()
# Tipo1.5
with  open(FILES_PATH + "\\JSON_Cargados\\Barcelona\\Tipo1.5_LECBP2R.json", "w") as f8:
    json.dump(tipo1_5, f8, indent=4)
f8.close()
# Tipo2
with  open(FILES_PATH + "\\JSON_Cargados\\Barcelona\\Tipo2_LECBP2R.json", "w") as f9:
    json.dump(tipo2, f9, indent=4)
f9.close()
# Asociacion
with  open(FILES_PATH + "\\JSON_Cargados\\Barcelona\\Asociacion_LECBP2R.json", "w") as f10:
    json.dump(asociacion_aeronaves_clusterizados, f10, indent=4)
f10.close()


with  open(FILES_PATH + "\\JSON_Cargados\\Barcelona\\Clusterizados2_LECBP2R.json", "w") as f6:
    json.dump(flujos_clusterizados, f6, indent=4)
f6.close()
#%%
...
datos2.to_csv("Barcelona_Final.csv", index=False, sep=",")
