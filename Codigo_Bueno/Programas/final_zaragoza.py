...
base_datos = pandas.read_csv(FILES_PATH + "\\Archivos\\Base_Datos_definitiva.csv", delimiter=',')
...
fichero2 = pandas.read_csv(FILES_PATH + '\\Archivos\\Puntos.csv', delimiter=',')
...
aerodromos = pandas.read_csv(FILES_PATH + "\\Archivos\\Aerodromos.csv", delimiter=",")
...
f6.close()
#%%
with  open(FILES_PATH + "\\JSON_Cargados\\Zaragoza\\Clusterizados_LECMTZI.json", "r") as f6:
...
datos2.to_csv("Daragoza_Final.csv", index=False, sep=",")
