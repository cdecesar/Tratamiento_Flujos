...
base_datos = pandas.read_csv("C:\\Users\\paco\\Desktop\\Excel\\Base_Datos_definitiva.csv", delimiter=',')
...
'''Este es el sector 2'''
df2 = base_datos.loc[base_datos.SectorCode=='LECMTZI',:]
print(df2.size)
...
fichero2 = pandas.read_csv('C:\\Users\\paco\\Desktop\\AgrupacionFlujos\\Puntos.csv', delimiter=',')
...
path_poligono = 'C:\\Users\\paco\\Desktop\\AgrupacionFlujos\\poligonos_sectores_2D_2.0.csv'
...
dataframe2['lon'] = lon
dataframe2['lat'] = lat
dataframe2['poligono'] = poligono

dataframe2.to_csv('Dataset_Poligono_Pamplona.csv', index=False, sep=',')
poligono = Polygon(l)

aerodromos = pandas.read_csv("C:\\Users\\paco\\Desktop\\AgrupacionFlujos\\Aerodromos.csv", delimiter=",")
...
for i in vuelos.keys():
    ...
    if len(coordenadas_nuevos_flujos.keys()) == 0:
        ...
        for j in coordenadas_nuevos_flujos.keys():
            ...
            if d_e < R1 and d_s < R1 and niveles_v[0] == niveles[0] and niveles_v[1] == niveles[1]:
...
base_datos2 = datos2.loc[datos2['Flujo_Clusterizado'] != '0']
base_datos2.to_csv("Zaragoza_Final.csv", index=False, sep=",")
...
dataframe1['lon'] = lon
dataframe1['lat'] = lat
dataframe1['flujo'] = flujo

dataframe1.to_csv('Dataset_Pamplona.csv', index=False, sep=',')
